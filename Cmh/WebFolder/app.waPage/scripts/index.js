...
WAF.onAfterInit = function onAfterInit() {// @lock
	...
	function buildTopNavBar () {
		...
		topNavData = [ // Array with menu item objects
			...
			{title: objTranslation.menuGame, componentpath: "/components/gamer/gamerGame.waComponent", menucomponentpath: "/components/gamer/gamerMenu.waComponent", topNavItemImagePath: "/images/Medical_Office.png", topNavItemId: "navGamecenter", topNavItemClass: "topNavItemLi topNavItemSelected"},
